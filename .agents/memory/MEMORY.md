...
- [Deriv websocket envelopes](deriv-websocket-envelopes.md) — API observable messages arrive under `message.data`; normalize before reading tick or contract payloads.
