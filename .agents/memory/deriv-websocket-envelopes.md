...
Deriv websocket subscribers in this project should read response payloads from `message.data` before checking `msg_type`, `tick`, or `proposal_open_contract`. A direct-response fallback is useful for isolated mocks.
